...
class BiLSTMModel(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, num_classes, dropout):
        ...
        self.fc = nn.Linear(2 * hidden_size, num_classes)  # Assuming 2 for bidirectional
...
model = BiLSTMModel(input_size, hidden_size, num_layers, num_classes, dropout).to(device)
